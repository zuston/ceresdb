...
use crate::{
    ...
    TableOptions, TableStatsOptions,
};
...
impl TableData {
    ...
    pub fn new(
        ...
        let metrics = Metrics::new(table_name.clone(), table_stats_opt);
    ...
    pub fn recover_from_add(
        ...
        let current_version = TableVersion::new(purge_queue);
        let metrics = Metrics::new(add_meta.table_name.clone(), table_stats_opt);
        let mutable_limit = AtomicU32::new(compute_mutable_limit(
